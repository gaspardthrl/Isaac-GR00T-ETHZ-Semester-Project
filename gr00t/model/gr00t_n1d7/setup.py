    ...
    def _create_model(self):
        ...
        if self.config.training.start_from_checkpoint is not None and not skip_weight_loading:
            ...
            model, loading_info = AutoModel.from_pretrained(
                ...
                cross_decoding_pairs=getattr(_m, "cross_decoding_pairs", None),
                lambda_cross=getattr(_m, "lambda_cross", 1.0),
                shared_embodiment_id=getattr(_m, "shared_embodiment_id", None),
                shared_target_closed=getattr(_m, "shared_target_closed", None),
